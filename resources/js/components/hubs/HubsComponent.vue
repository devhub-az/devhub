<template>
    <div>
        <div v-for="hub in hubs" v-if="!loading" class="list-hubs__hub">
        ...
        <ul v-if="loading" class="content-list">
            <li style="list-style-type: none;">
                <div class="list-hubs__hub">
                    ...
                    <div class="list-hubs__stats-value loading"
                         style="width: 20%; background: rgb(226, 226, 226); height: 1.2rem; margin: 0 auto;">
                    </div>
                    <div class="list-hubs__stats-value loading"
                         style="width: 60%; background: rgb(226, 226, 226); height: 1.7rem; margin-left: auto;">
                    </div>
                </div>
            </li>
        </ul>
