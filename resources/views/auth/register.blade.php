            ...
            <div class="ColumnContainer mode-auth">
                ...
                <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                    ...
                    <fieldset class="AnimatedForm__field m-required login hideable m-valid">
                        <input id="name" type="text" class="AnimatedForm__textInput {{ $errors->has('name') ? ' is-invalid' : '' }}" data-empty="false" name="name" value="{{ old('name') }}" required autofocus>
                    ...
                    <fieldset class="AnimatedForm__field m-required login hideable">
                        <input id="email" type="email" class="AnimatedForm__textInput {{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" data-empty="false" required>
                    ...
                    <fieldset class="AnimatedForm__field m-required password hideable">
                        <input id="password" type="password" class="AnimatedForm__textInput {{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" data-empty="false" required>
                    ...
                    <fieldset class="AnimatedForm__field m-required password hideable">
                        <input id="password-confirm" type="password" class="AnimatedForm__textInput {{ $errors->has('password') ? ' is-invalid' : '' }}" name="password_confirmation" data-empty="false" required>
