            ...
            <div class="page-header_wrapper">
                <div class="media-obj media-obj_company">
                    ...
                    <div class="media-obj__body media-obj__body_page-header media-obj__body_page-header_branding">
                        <div class="page-header__info">
                            ...
                            <sup class="page-header__stats-value page-header__stats-value_branding" title="Рейтинг компании">399,64</sup>
                ...
                <div class="page-header__buttons">
                    <button type="button" class="page-header__button btn" data-id="2198" data-state="follow">
                        <span class="btn__value"><i class="icon feather icon-user-plus"></i> Abunə olun <span class="folowers">{{ \Numeric::number_format_short(123) }}</span></span>
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="post-share">
                  ...
                  <ul class="post-share__buttons social-icons">
                    <li class="social-icons__item social-icons__item_post">
                      <a href="https://www.facebook.com/sharer/sharer.php?u={{ URL::current() }}" class="social-icons__item-link social-icons__item-link_normal social-icons__item-link_facebook" title="Опубликовать ссылку в Facebook" onclick="window.open(this.href, 'Опубликовать ссылку в Facebook', 'width=640,height=436,toolbar=0,status=0'); return false">
                    ...
                    <li class="social-icons__item social-icons__item_post">
                      <a href="https://vk.com/share.php?url={{ URL::current() }}" class="social-icons__item-link social-icons__item-link_normal social-icons__item-link_vkontakte" title="Опубликовать ссылку во ВКонтакте" onclick="window.open(this.href, 'Опубликовать ссылку во ВКонтакте', 'width=800,height=300,toolbar=0,status=0'); return false">
                    ...
                    <li class="social-icons__item social-icons__item_post">
                      <a href="https://t.me/share/url?url={{ URL::current() }}&amp;title={{ $post['name'] }}" class="social-icons__item-link social-icons__item-link_normal social-icons__item-link_telegram" title="Поделиться ссылкой в Telegram" onclick="window.open(this.href, 'Поделиться ссылкой в Telegram', 'width=800,height=300,toolbar=0,status=0'); return false">
                ...
                <div id="comments" class="post-comments">
                    ...
                    <form method="post" action="{{ route('new-comment') }}">
                        ...
                        <div class="post-comment">
                            ...
                            <div class="comment-body">
                                ...
                                <p><textarea class="input" style="padding: 5px;" rows="2" cols="20000" name="body" class="comment-text"></textarea></p>
                    ...
                    <blockquote class="blockquote">
                    	Yalnız <a href="{{ route('register') }}">istifadəçilər</a> şərh yaza bilər. Xahiş edirik <a href="{{ route('login') }}">daxil olun</a>.
                    </blockquote>
                    @endif
                </div>
            </div>
        ...
        <div id="main-content" class="content_right">
            <div id="default-block" class="block default-block_sidebar">
                <div class="user-card">
                    ...
                    <div class="content">
                        <div class="header"><a class="author_name" href="{{ url('@' . $post['creator']['username']) }}">{{ $post['creator']['username'] }}</a> <span class="author">Müəllif</span></div>
                        <div class="meta">
                            ...
                            <div class="media-obj__body media-obj__body_user-info">
                                <div>
                                    <div class="stacked-counter-karm__value">{{ $post['creator']['karm'] }}</div>
                    ...
                    <div class="extra content">
                        <div class="right floated created">
                            Goşulub {{ Carbon\Carbon::parse($post['creator']['created_at'])->format('Y') }}
                        </div>
                        <div class="friends">
                            <i class="user icon"></i>
                            Abunəçilər {{ \Numeric::number_format_short(1233) }}
                        </div>
                    </div>
                </div>
            </div>
