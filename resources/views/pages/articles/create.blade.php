                            ...
                            <div class="overflow-hidden divide-y rounded bg-white dark:bg-transparent text-black p-5">
                                <div class="flex items-center space-x-3 pb-3">
                                    <div class="relative w-10 h-10">
                                        <span class="iconify w-10 h-10 rounded dark:text-gray-300"
                    ...
                    <div>
                        ...
                        <div class="mb-5 rounded dark:bg-dpaper border dark:border-gray-700">
                            <div class="overflow-hidden rounded bg-white dark:bg-transparent text-black p-5 space-y-2">
                                <div class="pb-2 text-sm dark:text-gray-300">
                                    Не надо пропускать:
                                </div>
                                <ul class="list-none list-disc pl-4 space-y-2 dark:text-gray-400">
                                    ...
                                    <li class="text-sm">статьи без правильно расставленных знаков препинания, со
                                        смайликами, с
                                        обилием восклицательных знаков, неоправданным выделением слов и предложений и
                                        другим
