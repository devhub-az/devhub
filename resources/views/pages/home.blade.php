            ...
            <div class="w-right xs:w-full">
                <div class="sticky top-2">
                    <a href="{{ route('create_article') }}"
                       class="border leading-10 text-base flex justify-center block items-center xs:hidden border-cerulean-600 w-full dark:bg-cerulean-700 dark:border-cerulean-700 xs:block xs:text-center xs:py-2 xs:w-full uppercase text-xs rounded text-gray-100 bg-cerulean-600 hover:opacity-90">
