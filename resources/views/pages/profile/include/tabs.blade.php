<div class="bg-white overflow-hidden mb-2 dark:bg-dpaper border dark:border-gray-700">
    <div class="flex space-x-4 px-4">
        <a href="{{ route('user_info', $author->attributes->username) }}"
           class="text-xs trans-none py-2 hover:border-b-2 hover:border-cerulean-100 {{ Route::currentRouteName() === 'user_info' ? 'border-b-2 bottom-0 border-cerulean-100 text-cerulean-100' : 'text-gray-500 dark:text-gray-300' }}">
        ...
        <a href="{{ route('user_articles', $author->attributes->username) }}"
           class="text-xs trans-none py-2 hover:border-b-2 hover:border-cerulean-100 {{ Route::currentRouteName() === 'user_articles' ? 'border-b-2 bottom-0 border-cerulean-100 text-cerulean-100' : 'text-gray-500 dark:text-gray-300' }}">
            <div class="flex items-center space-x-1 text-sm xs:text-xs font-medium">
