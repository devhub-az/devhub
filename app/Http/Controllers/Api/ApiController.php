...
class ApiController extends Controller
{
    ...
    {
        return Fractal::create()->parseIncludes($includes)->item($item, $callback)->jsonSerialize();
    }
    ...
    {
        return Fractal::create()->collection($collection, $callback)->parseIncludes($includes)->toArray();
    }
