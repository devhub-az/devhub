<header class="border-t-4 border-blue bg-header">
    <div class="flex items-center justify-between h-12 xs:h-auto lg:container mx-auto">
        <div class="grid xs:block grid-flow-col xs:text-center xs:w-full gap-3">
            <a class="text-gray-100 text-2xl border-r border-gray-300 pr-2 xs:border-none font-bold hover:text-gray-200 md:text-2xl m-auto"
        ...
        <div class="grid grid-flow-col gap-3 xs:hidden" id="header_app">
            ...
            @guest
                ...
                <a href="{{ route('login') }}"
                   class="border border-gray uppercase text-xs rounded px-2 py-1 text-gray-100 bg-transparent">Daxil
                                                                                                               ol</a>
                <a href="{{ route('register') }}"
                   class="border border-blue uppercase text-xs rounded px-2 py-1 text-gray-200 bg-blue">Qoşulmaq</a>
            @else
