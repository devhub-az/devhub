        ...
        <form @submit.prevent="submit">
            <fieldset>
                <div class="settings__block">
                    <label for="name">Əsl adınız {{ name_count }}/40:</label>
                ...
                <div class="settings__block">
                    <p class="settings__block-name">Dil:</p>
                    <div class="settings__right-block">
                        <label>
                        ...
                        <p class="explain">Saytın interfeysini görmək istədiyiniz dili seçin.</p>
                    </div>
                </div>
                <div class="settings__block">
                    <label for="email">Sizin emailiniz: {{ email }}</label>
                    <div class="settings__right-block">
                ...
                <div class="settings__block settings__submit">
                    <dt></dt>
                    <div class="settings__right-block">
                        <button type="submit" class="btn btn-primary">Ydadda saxla</button>
                    </div>
                </div>
            </fieldset>
        </form>
